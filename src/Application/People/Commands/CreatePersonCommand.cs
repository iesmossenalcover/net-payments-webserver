...
public class CreatePersonCommandValidator : AbstractValidator<CreatePersonCommand>
{
    ...
    public CreatePersonCommandValidator(IPeopleRepository peopleRepo)
    {
        ...
        RuleFor(x => x.DocumentId)
            ...
            {
                return await _peopleRepo.GetPersonByDocumentIdAsync(DocumentId, true, ct) == null;
        ...
        RuleFor(x => x.AcademicRecordNumber)
            ...
            .MustAsync(async (x, ct) =>
            {
                ...
                return await _peopleRepo.GetPersonByAcademicRecordAsync(x.Value, true, ct) == null;
