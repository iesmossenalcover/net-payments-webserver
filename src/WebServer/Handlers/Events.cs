...
public class Events
{
    ...
    public static async Task<Response<SendDailyEventsEmailCommandVm>> SendDailyEventsEmail(IMediator mediator, [FromQuery] DateOnly? day = null)
    {
        return await mediator.Send(new SendDailyEventsEmailCommand(day));
    }
